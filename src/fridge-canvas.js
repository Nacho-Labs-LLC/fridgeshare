...
class FridgeCanvas {
  ...
  _createDrawToolbar() {
    ...
    clearBtn.setAttribute("aria-label", "Erase all strokes");
    ...
    doneBtn.setAttribute("aria-label", "Exit drawing mode");
  ...
  applyTrayStyle(styleId) {
    ...
    const btn = document.querySelector("#tray-style-button");
    if (btn) {
      btn.title = `Tray style: ${labels[styleId] || styleId} — click to cycle`;
      btn.setAttribute("aria-label", `Tray style: ${labels[styleId] || styleId}`);
    }
  }
